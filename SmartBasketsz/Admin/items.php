...
<div class="container mt-4">
    ...
    <!-- Add New Item Button -->
    <div class="mb-3">
        <a class="btn btn-success" href="addItem.php">Add New Item</a>
    </div>
    ...
    <table class="table table-striped table-success">
        <thead>
        <tr>
            <th colspan="10" style="text-align: center; font-size: 30px;">Items</th>
        </tr>
        <tr>
            <th>Index</th>
            <th>ID</th>
        ...
        if ($result && $result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<tr>
                      ...
                      <td>{$row['basePrice']}</td>
                      <td>{$row['salePrice']}</td>
                      <td><img src='../ItemImages/" . $row['image'] . "' alt='Item Image' height='50px' width='50px'></td>
                      <td>
